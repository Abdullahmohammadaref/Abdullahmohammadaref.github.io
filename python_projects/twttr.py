...
def main():   # this function call the convert function output and prints the result
    ...
    output_withought_vowel = convert(input_with_vowel)
    print("output:", output_withought_vowel)

def convert(input): # this function ask the user for an input and the it deletes vowl letters
    ...
    for c in input:  # this loop goes through the letters one by one.
        if c in vowels:
